...
{
    protected $view_path    = 'admin.labs';
    protected $route_prefix = 'admin.labs.';
    ...
    public function store(Request $request)
    {
        ...
        return redirect()
            ...
            ->with('success', 'Phòng bộ môn đã được thêm thành công.');
    }
    ...
    public function update(Request $request, string $id)
    {
        ...
        return redirect()
            ->back()
            ->with('success', 'Phòng bộ môn đã được cập nhật.');
    }
    ...
    public function destroy(Request $request, string $id)
    {
        ...
        return redirect()
            ...
            ->with('success', 'Phòng bộ môn đã được xóa.');
    }
}
