    ...
    <div class="col-lg-6">
        ...
        <div class="form-group mb-4">
            ...
            <select name="export_by" class="form-control preview-demo" id="export_by">
                <option value="tiet" data-img="/system/export/preview/borrowdevice.png">Tiết</option>
                <option value="phieu" data-img="/system/export/preview/borrowdevice.png">Phiếu</option>
            </select>
